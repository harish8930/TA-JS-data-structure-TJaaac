...
let genresmov = movies[0].genres;
for(let i =0; i<genres.length;i++){
  console.log ( genresmov[i]);
}

// 19. Log all the genres of the second movie one by one
let genresmov2 = movies[1].genres;
for(let i =0; i<genres.length;i++){
  console.log ( genresmov2[i]);
}
...
if(movies[0].actors[0] === "Rachel McAdams"){
  console.log("true")}else if(movies[0].actors[0] !== "Rachel McAdams"){
  console.log("false")};
...
if(movies[1].actors[1] === "Natalie Portman"){
  console.log("true")}else if(movies[0].actors[0] !== "Natalie Portman"){
  console.log("false")};
